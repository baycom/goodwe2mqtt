...
const ETPayloadParser_89e8 = new Parser()
	...
	.seek((35336 - 35307) * 2)
	.uint16be('MPPT1Power', { formatter: (x) => { return x!=65535?x:0; } })
	.uint16be('MPPT2Power', { formatter: (x) => { return x!=65535?x:0; } })
	.uint16be('MPPT3Power', { formatter: (x) => { return x!=65535?x:0; } })
	.seek((35344 - 35339) * 2)
	.uint16be('MPPT1Current', { formatter: (x) => { return x!=65535?(x/10.0):0; } })
	.uint16be('MPPT2Current', { formatter: (x) => { return x!=65535?(x/10.0):0; } })
	.uint16be('MPPT3Current', { formatter: (x) => { return x!=65535?(x/10.0):0; } })
;
